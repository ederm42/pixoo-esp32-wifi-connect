...
via requests. Python handles the conversion of images/commands to bluetooth data and sends the requests containing the 
data of any image/command you want to display.
...
Once uploaded, the ESP32 should start up. Your Pixoo should, for a brief moment, flash a bluetooth 
icon on the screen.
...
* `draw_gif()`: displays an animation on the Pixoo based on a GIF file (16x16 pixels)
